...
def test_pointcloud1_response_poses():
    pointcloudN_response_poses(1, [ 1.92464301, -0.86583511,  1.83260872,  0.15936917], 0.2, 0.2)
...
def test_pointcloud5_response_poses():
    ...
    pointcloudN_response_poses(5, [ 0.77042134,  1.17211075, -0.11192256,  1.37172797], 0.2, 0.2)

def test_pointcloud6_response_poses():
    pointcloudN_response_poses(6, [ 1.97781148, -0.26113639,  1.94257214,  0.68463575], 0.2, 0.2)
